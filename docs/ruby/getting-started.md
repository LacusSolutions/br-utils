...
Os métodos de CPF são acessados via `BrUtils.cpf`, `utils.cpf`, `CpfUtils` ou os helpers `CpfFmt` / `CpfGen` / `CpfVal`. O CPF usa a API de [`cpf-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cpf-utilities/README.pt.md).
...
Os métodos de CNPJ são acessados via `BrUtils.cnpj`, `utils.cnpj`, `CnpjUtils` ou os helpers `CnpjFmt` / `CnpjGen` / `CnpjVal`. O CNPJ usa a API de [`cnpj-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cnpj-utilities/README.pt.md).
...
Consulte [`cpf-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cpf-utilities/README.pt.md) e [`cnpj-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cnpj-utilities/README.pt.md) para detalhes completos de opções e erros.
...
`CpfUtils::*` / `CnpjUtils::*` de uso indevido também se propagam quando agregadores aninhados são construídos ou chamados via `BrUtils`. Para tabelas de opções e casos extremos, veja [`cpf-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cpf-utilities/README.pt.md) e [`cnpj-utilities`](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cnpj-utilities/README.pt.md).
...
|---------|----------------|--------|
| [`cpf-utilities`](https://rubygems.org/gems/cpf-utilities) | `CpfUtils`, `CpfFormatter`, `CpfGenerator`, `CpfValidator`, `CpfFmt.cpf_fmt`, `CpfGen.cpf_gen`, `CpfVal.cpf_val` | [docs](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cpf-utilities/README.pt.md) |
| [`cnpj-utilities`](https://rubygems.org/gems/cnpj-utilities) | `CnpjUtils`, `CnpjFormatter`, `CnpjGenerator`, `CnpjValidator`, `CnpjFmt.cnpj_fmt`, `CnpjGen.cnpj_gen`, `CnpjVal.cnpj_val` | [docs](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/cnpj-utilities/README.pt.md) |
...
Veja o [CHANGELOG](https://github.com/LacusSolutions/br-utils-ruby/blob/main/packages/br-utilities/CHANGELOG.md) para alterações e histórico de versões.
